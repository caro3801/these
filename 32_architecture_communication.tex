...
\begin{itemize}
	...
	\item efficace en terme d'accès et de distribution de la donnée ; 
...
détection de conflit (source de vérité plus proche des pairs producteurs). 
...
réseau et d'applications. Chaque pair comprend un protocole pour la gestion
