...
un historique performant qui profite de chaque connexion au réseau  pour mettre à jour le système.\improve{en remettre une couche}
...
indépendamment des besoins du rendu (lumière, matériau\dots). Le framework intègre un 
...
\begin{itemize}
	...
	journaux d'événements au traitement des événements.\info{reference à la 
	section}.
\end{itemize}
...
répliqués sur les sites distants de manière asynchrone\todo{cf section p2p}. 
...
sur chacun des sites participants.\info{point d'entrée = network bridge}
...
cet ordonnancement. Les répliques distantes du journal d'événements sont cohérentes 
si les évènements respecte l'ordre causale \cite{Lamport1978} : les 
