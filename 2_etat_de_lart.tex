...
Les communications non ordonnées sont plus simple à 
...
La livraison de paquet ordonnés est souvent une fonctionnalité appréciée dans le 
...
à la taille des données envoyées. La responsabilité de vérifier quels sont les 
