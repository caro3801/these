...
%
	\begin{figure}[!h]
		...
		\centering
		\noindent
		\subfloat[Nouvel évènement en \gls{ES}]{
...
navigateur) a fait apparaître de nouvelles possibilités concernant la visualisation et 
...
prépondérants.
Différentes approches parmi les architecture orientée évènements dans un 
...
principes permettent d'avoir une vision centrée métier au logiciel. A partir de ces 
orientations, \gls{CQRS} vient proposer une discrimination entre la partie écriture 
(commande) et lecture (requête) dans l'application. Le passage à l'échelle côté 
lecture est favorisé grâce à la création de projections des données facilite la 
restitution des données sans risques d'effets de 
