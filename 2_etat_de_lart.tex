...
sont dites optimistes, car plus permissives, ne s'empêchent pas la possibilité de 
...
Plateforme de publication d'objets \gls{3D} populaire, TinkerCAD se focaliser sur l'accès à la 
...
Avec le \gls{DDD}, un projet est vu a travers le prisme du domaine d'application 
