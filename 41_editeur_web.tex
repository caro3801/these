...
dans le domaine.De cette manière, le modèle orienté évènements présenté dans 
...
règles métiers définies et les exceptions liés à la cohérence, l'évènement peut être 
business 
...
\begin{figure}
	...
	d'évènements (ei) qu'il contient. Les types des évènements sont relatifs au type 
