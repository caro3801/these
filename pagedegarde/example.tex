...
% - laboratory
% - cotutelle
\title{\textbf{\large Architecture �v�nementielle pour les Environnements Virtuels 
		Collaboratifs 
		sur le Web : Application � la Manipulation et � la 
		Visualisation d'Objets 3D}}
\author{Caroline DESPRAT}
\defencedate{15/11/2017}
...
\makesomeone{referee}{2}{Guillaume LAVOU�}{}{}
%% Judges
\njudge{5}
