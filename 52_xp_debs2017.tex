...
(questionnaire\todo{ref questionnaire annexe}) lors de l'exécution d'une tâche 
...
\paragraph{Procédure}
Les modèles utilisés lors de l'expérience sont décrits dans le Tableau 
...
du travail d'analyse présenté ici. Ces traces, composées d'événements 
...
l'utilisateur. Dans les premiers moments, les participants ont fortement interagi (jusqu'à 20 
...
MeshScaledEvent est détecté. A posteriori, je me suis rendu compte que la 
...
ces modèles ne sont pas très complexes et que tous les participants étaient 
débutants sur le système et n'étaient pas forcément familiers avec ce genre 
d'application. 
...
ont apprécié positivement de faire de la modélisation collaborative \gls{3D} dans un 
navigateur web. Quant à savoir si le nombre d'utilisateurs améliore à la fois 
