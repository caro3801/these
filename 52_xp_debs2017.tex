...
utilisant l'application 3DEvent et les fonctionnalités décrites précédemment\info{ref section fonctionnalités} pour que le résultat corresponde à l'assemblage 
...
Chaque participant était localisé en France dans une zone urbaine disposant de bonnes 
...
MeshScaledEvent est détecté. \textit{A posteriori}, nous nous sommes rendu compte que la 
