...
activités. L'utilisabilité, qui correspond à la qualité de l'expérience utilisateur fournit par un système 
...
La testabilité de l'application est aisément envisageable car tous les composants 
sont faiblement couplés entre eux. 
Chaque bloc de l'\gls{IU} est isolé. Le caractère fonctionnel de l'\gls{ES} permet de 
