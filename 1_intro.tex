...
partagé.
Plusieurs problèmes, liés aux domaines des systèmes distribués (et les 
protocoles 
...
\info{consistency cohérence conflits} L'analyse des applications utilisant des 
...
avec des compétences et connaissances variées doit pouvoir se réunir autour d'un 
...
évènements sont bien adaptées pour d'intégrer dans la description des 
...
À l'ajout d'information sémantique sur les données, les 
architectures orientées évènements enrichissent les applications de la possibilité 
