...
\begin{itemize}
	...
	\item Modèle événementiel pour la manipulation et la visualisation d'objets \gls{3D} de manière collaboration : proposition d'un modèle CQRS ES uniquement sur le client avec un historique fonctionnel et une gestion de la cohérence intégrée.
